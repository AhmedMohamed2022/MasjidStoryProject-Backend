        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchStyle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DateOfRecord = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    YearOfEstablishment = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Masjids_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePublished = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MasjidId = table.Column<int>(type: "int", nullable: true),
                    CreatedById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LanguageId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasjidContents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MasjidContents_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MasjidContents_Masjids_MasjidId",
                        column: x => x.MasjidId,
                        principalTable: "Masjids",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasjidVisits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MasjidVisits_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MasjidVisits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MasjidVisits_Masjids_MasjidId",
                        column: x => x.MasjidId,
                        principalTable: "Masjids",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityContents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommunityContents_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityContents_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventContents_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DateLiked = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    StoryId = table.Column<int>(type: "int", nullable: true),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MasjidId = table.Column<int>(type: "int", nullable: true),
                    MasjidId1 = table.Column<int>(type: "int", nullable: true),
                    StoryId = table.Column<int>(type: "int", nullable: true),
                    StoryId1 = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityContents_CommunityId",
                table: "CommunityContents",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityContents_LanguageId",
                table: "CommunityContents",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventContents_LanguageId",
                table: "EventContents",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasjidContents_LanguageId",
                table: "MasjidContents",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_MasjidContents_MasjidId",
                table: "MasjidContents",
                column: "MasjidId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Masjids_CountryId",
                table: "Masjids",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_MasjidVisits_ApplicationUserId",
                table: "MasjidVisits",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MasjidVisits_MasjidId",
                table: "MasjidVisits",
                column: "MasjidId");

            migrationBuilder.CreateIndex(
                name: "IX_MasjidVisits_UserId",
                table: "MasjidVisits",
                column: "UserId");
